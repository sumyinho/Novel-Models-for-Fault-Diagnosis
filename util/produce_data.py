...
def get_batch(filename, window_size=512, batch_size=1000, stride=45):
...
for root, dirs, files in os.walk("../dataset/XJTU-SY_Bearing_Datasets/"):
    print(files)

output_path = '../dataset/XJTU-SY_Bearing_Datasets/image'
