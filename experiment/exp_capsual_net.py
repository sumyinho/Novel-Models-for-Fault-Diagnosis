...
from model.capsual_net import CapsuleNet
...
with open(root + "XJTU-cwt.pkl", "rb") as f:
...
for train_index, test_index in k_flod_idx:
    ...
    model = CapsuleNet(number_of_class=number_of_class)
    model_best = model
    accuracy_best = 0
    model.to(device)
...
with open("../experiment_data/baseline_cnn_CWRU.pkl", "wb") as f:
