...
from model.att_mbigru import AttMBiGRU
from model.laplace_alexnet import AlexNet
...
for root, dataset_name in root_dict.items():
    ...
    for train_index, test_index in k_flod_idx:
        ...
        test_data = fold_signal(test_data)
        ...
        model = AttMBiGRU(sequence_length=16, number_of_class=number_of_class, dropout=.6)
