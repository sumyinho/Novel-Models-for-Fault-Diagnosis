# model = BaselineLSTM(input_size=16, hidden_size=100, output_size=3, sequence_length=64)
# def transform(data):
#     return data.reshape(-1, 16, 64)
import torch
import pickle
import time
import numpy as np
...
for root, dataset_name in root_dict.items():
    ...
    for train_index, test_index in k_flod_idx:
        ...
        model = BaselineLSTM(input_size=1, hidden_size=100, output_size=number_of_class, sequence_length=1024)
